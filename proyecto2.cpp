//Codificado por: Michelle Camacho y Elisa Valles
//Solucion de problemas con programacion en c++
//Profesor; Ken Bauer
#include<iostream>
using namespace std;
int main()
{
    int x;
    cout<<"Inserta un numero, por favor"<<endl;
    cin>>x;
if((x<1)||(x>999)) cout<<"Tu numero es demasiado grande, podrias insertar un numero del 1 al 999, por favor: ";
else
